...
const COLOR_MAP: Record<TileType, TileColors> = {
  ...
  pay_taxes: { bg: 'bg-pink-700', text: 'text-white', border: 'border-pink-500', label: 'Pay Taxes', stripeColor: '#BE185D' },
  chance: { bg: 'bg-indigo-600', text: 'text-white', border: 'border-indigo-400', label: 'Chance', stripeColor: '#4338CA' },
